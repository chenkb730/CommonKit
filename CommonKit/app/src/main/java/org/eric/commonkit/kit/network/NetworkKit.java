...
public class NetworkKit {
    ...
    public static int getNetworkType() {
        NetworkInfo info = ManageKit.getConnectivtyManager(
                CKApplication.context).getActiveNetworkInfo();
    ...
    public static boolean isEDGE() {
        ...
        if (info != null && info.isAvailable()) {
            if (TelephonyManager.NETWORK_TYPE_EDGE == info.getSubtype())
                return true;
        }
    ...
    public static boolean isWifiConnecting() {
        return ManageKit.getConnectivtyManager(CKApplication.context)
    ...
    public static boolean isConnectingToInternet() {
        ConnectivityManager connectivityManager = ManageKit
                .getConnectivtyManager(CKApplication.context);
