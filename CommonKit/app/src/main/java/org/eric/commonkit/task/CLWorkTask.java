...
public abstract class CLWorkTask<Params, Progress, Result> {
    private static final String TAG = "CLWorkTask";
    /**
     * 加载图片默认是10个线程
     */
    ...
    private CLTaskException exception;
    ...
    public enum Status {
        ...
        RUNNING,
        /**
         * Indicates that {@link  #onPostExecute} has finished.
         */
        FINISHED,
    }
    ...
    public CLWorkTask(String taskId, ITaskManager taskManager) {
        this();
        this.taskId = taskId;
     ...
     */
    protected void onFailure(CLTaskException exception) {
     ...
     * @param params
     * @return
     * @throws CLTaskException
     */
    abstract public Result workInBackground(Params... params) throws CLTaskException;
...
//			}
     ...
     * @return
     */
    public final CLWorkTask<Params, Progress, Result> executeOnSerialExecutor(Params... params) {
     ...
     * @return
     */
    public final CLWorkTask<Params, Progress, Result> executrOnImageExecutor(Params... params) {
     ...
     * @return
     */
    public final CLWorkTask<Params, Progress, Result> execute(Params... params) {
        return executeOnExecutor(THREAD_POOL_EXECUTOR, params);
    }

    public final CLWorkTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        final CLWorkTask mTask;
        final Data[] mData;

        AsyncTaskResult(CLWorkTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
