...
import org.eric.commonkit.http.AjaxCallBack;
import org.eric.commonkit.http.AjaxParams;
import org.eric.commonkit.http.HttpHandler;
import org.eric.commonkit.http.RetryHandler;
import org.eric.commonkit.http.SyncRequestHandler;
...
public class CKHttp {
    ...
    private static final ThreadFactory sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            Thread tread = new Thread(r, "CKHttp #" + mCount.getAndIncrement());
